...
if __name__ == "__main__":
    ...
    for n_obs in tqdm(n_obs_list):
        ...
        output_fn = f"mnist_umap_obs{n_obs}.png"
        ...
        ax.set_title("MNIST UMAP visualization")
        ax.legend()
        pp.savefig(output_fn)

    json.dump(result, open("umap_results.json", "w"), ensure_ascii=False, indent=2, sort_keys=True)
